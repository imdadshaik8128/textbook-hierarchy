...
def process_subject_folder(subject_path, overwrite=True):
    md_path = os.path.join(subject_path, "full_cleaned.md")
...
def main():
    root_folder = "DataBase/10_Social_Economics_textbook_2024-25_even_pages.pdf-0900b904-0a7d-48fa-b80e-11a4f4e34973"  # change if needed
